...
Ce fichier conserve l'historique principal des releases.

- Version du code actuellement dans le depot : `v6.0.1` (voir `package.json`)
- Details complets des publications recentes : onglet Releases GitHub

## v6.0.1 - 2026

### Corrections

- Corrections iOS (icones et configuration de build)
- Correction d'un cas d'affichage sur Proxiwash (derniere machine cachee)

## v6.0.0 - 2026

### Evolutions techniques

- Mise a jour majeure du socle React Native/React et des dependances
- Nettoyage de composants historiques (suppression de code obsolete)
- Mise a niveau des workflows CI (Node 24)

---

# Historique detaille - v5.2.2 - 18/09/2022
...
- Déplacement du bouton _À propos_ dans les paramètres
