...
Si tu utilises Windows, les commandes restent les mêmes dans l'ensemble, avec quelques adaptations de chemin.
...
- [3. Installation de l'application](#3-installation-de-lapplication)
  - [3.1 Téléchargement du dépôt](#31-téléchargement-du-dépôt)
...
Pour les versions Android SDK/NDK utilisées pour compiler ce projet, consulte aussi [ce document](ANDROID_TOOLCHAIN.md).
